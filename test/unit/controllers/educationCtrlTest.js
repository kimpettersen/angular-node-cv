...
describe('Controller: EducationCtrl', function() {
  ...
  beforeEach(inject(function($rootScope, $controller, CVServiceMock) {
    ...
    scope = $rootScope.$new();
    adminServiceInst = new CVServiceMock.adminService('education');
  ...
  describe('reset functionality', function(){
    ...
    it('should set the model adminService.education.item to {}', function(){
      scope.adminService.education.item = { hallo:'123' };
      scope.resetCurrent();
      expect(scope.adminService.education.item).toEqual({});
    });
  });
