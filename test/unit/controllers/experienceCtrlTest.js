...
describe('Controller: ExperienceCtrl', function() {
  ...
  beforeEach(inject(function($rootScope, $controller, CVServiceMock) {
    var adminServiceInst = new CVServiceMock.adminService('experience')
    scope = $rootScope.$new();
  ...
  describe('reset functionality', function(){
    ...
    it('should set the model adminService.experience.item to {}', function(){
      scope.adminService.experience.item = { hallo:'123' };
      scope.resetCurrent();
      expect(scope.adminService.experience.item).toEqual({});
    });
  });
